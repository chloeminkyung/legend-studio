...
export enum PERSISTENCE_HASH_STRUCTURE {
  ...
  // testSuite
  PERSISTENCE_CONNECTION_TEST_DATA = 'CONNECTION_TEST_DATA',
  PERSISTENCE_TEST_DATA = 'TEST_DATA',
  PERSISTENCE_TEST_SUITE = 'TEST_SUITE',
  PERSISTENCE_TEST = 'TEST',
  PERSISTENCE_PARAMETER_VALUE = 'PARAMETER_VALUE',
